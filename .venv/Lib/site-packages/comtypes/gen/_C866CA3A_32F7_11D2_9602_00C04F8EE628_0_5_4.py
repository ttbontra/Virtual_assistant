...
__all__ = [
    'SPRS_INACTIVE', 'SECFDefault', 'SpeechEmulationCompareFlags',
    'SpeechGrammarTagWildcard', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SPEsCount', 'DISPID_SRSClsidEngine', 'STSF_LocalAppData',
    ...
    'ISpPhoneticAlphabetConverter', 'SDTReplacement',
    'SPSEMANTICERRORINFO', 'DISPID_SPRText',
    'SpeechGrammarRuleStateTransitionType', 'SPRULE',
    'DISPID_SRRPhraseInfo', 'SAFTNonStandardFormat',
    'DISPID_SGRsCommit', 'DISPID_SGRSTsCount',
    'DISPID_SRCERecognitionForOtherContext', 'SPDATAKEYLOCATION',
    'DISPID_SOTSetId', 'DISPID_SPRuleNumberOfElements',
    'SpeechPropertyHighConfidenceThreshold', 'SpUnCompressedLexicon',
    'ISpRecognizer', 'SPEI_SR_BOOKMARK', 'DISPID_SPPs_NewEnum',
    'DISPID_SVEEnginePrivate', 'SAFTCCITT_uLaw_22kHzMono',
    'SPGS_DISABLED', 'SRSEDone', 'STCInprocHandler',
    'DISPID_SAStatus', 'SPRECOCONTEXTSTATUS', 'eLEXTYPE_PRIVATE5',
    'SAFTCCITT_uLaw_11kHzStereo', 'ISpeechPhraseReplacements',
    'SpeechEngineConfidence', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SPRuleConfidence', 'DISPID_SVSCurrentStreamNumber',
    'SPEI_TTS_PRIVATE', 'SpeechStreamFileMode', 'SGDSActive',
    'ISpeechPhraseElement', 'SVESentenceBoundary',
    'SAFT11kHz16BitStereo', 'SPSERIALIZEDRESULT',
    'SpeechCategoryPhoneConverters', 'DISPID_SRGRecoContext',
    'SpeechTokenShellFolder', 'SREStateChange', 'ISpeechRecoGrammar',
    'DISPID_SLPs_NewEnum', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SpeechMMSysAudio', 'SDTAll', 'SpeechAudioProperties',
    'Speech_StreamPos_Asap', 'DISPID_SPPId', 'SPSFunction',
    'SP_VISEME_13', 'DISPID_SRGRules', 'SPDKL_LocalMachine',
    'DISPID_SVSInputSentenceLength', 'eLEXTYPE_PRIVATE2',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SAEventHandle',
    'SGLexical', 'DISPID_SPPChildren', 'DISPID_SPPNumberOfElements',
    'SpPhoneticAlphabetConverter', 'SGLexicalNoSpecialChars',
    'DISPID_SDKEnumKeys', 'DISPID_SpeechPhraseAlternates',
    'SPWF_SRENGINE', 'DISPID_SGRs_NewEnum',
    'DISPID_SLWPronunciations', 'SpeechLexiconType',
    'DISPID_SRSetPropertyString', 'SRESoundEnd', 'DISPID_SOTDataKey',
    'ISpeechLexiconWord', 'DISPID_SOTCreateInstance',
    'SpeechRecoEvents', 'DISPID_SABIBufferSize', 'SP_VISEME_8',
    'SPBO_PAUSE', 'SPWT_LEXICAL', 'SAFT16kHz8BitMono',
    'DISPID_SRIsShared', 'DISPIDSPTSI', 'SPEI_RESERVED2',
    'SPBO_AHEAD', 'SRERequestUI', 'DISPID_SWFESamplesPerSec',
    'IEnumString', 'SSTTWildcard', 'SpeechCategoryAppLexicons',
    'SPFM_OPEN_READONLY', 'SVEVoiceChange', 'SpeechAllElements',
    'DISPID_SPRs_NewEnum', 'DISPID_SRGIsPronounceable',
    'DISPID_SPPsItem',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpWaveFormatEx', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SGRSTRule', 'SpeechGrammarState', 'SSFMCreate',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SpeechPhraseProperty',
    'SWPUnknownWordPronounceable', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SRCEStartStream', 'SPEI_TTS_AUDIO_LEVEL', 'SVP_19',
    'DISPID_SPERetainedStreamOffset', 'SpPhoneConverter',
    'SVSFVoiceMask', 'DISPID_SOTRemoveStorageFileName',
    'ISpRecoCategory', 'SGPronounciation',
    'DISPID_SRCRetainedAudioFormat', 'SPLO_STATIC',
    'SAFTCCITT_uLaw_22kHzStereo', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPWORDTYPE', 'SPEI_ACTIVE_CATEGORY_CHANGED', 'SRAONone', 'SVP_2',
    'SRTExtendableParse', 'SPSMF_UPS', 'SPEVENTENUM',
    'SAFT44kHz16BitMono', 'eLEXTYPE_APP', 'SPVOICESTATUS',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SOTDisplayUI', 'SWTAdded',
    'DISPID_SRGSetTextSelection', 'eLEXTYPE_PRIVATE19',
    'SPEI_RECOGNITION', 'SPEI_SOUND_START',
    'DISPID_SpeechAudioFormat', 'IStream',
    'DISPID_SLAddPronunciation', 'SPSVerb', 'SPEI_RECO_STATE_CHANGE',
    'SAFTCCITT_ALaw_11kHzMono', 'SP_VISEME_5',
    'SpeechPropertyResponseSpeed', 'SPRST_INACTIVE_WITH_PURGE',
    'SP_VISEME_7', 'ISpeechDataKey', 'DISPID_SpeechObjectToken',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SVGetProfiles',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SPEs_NewEnum', 'SGSExclusive',
    'SPVPRI_ALERT', 'SGDSActiveWithAutoPause', 'SVSFParseSsml',
    'ISpeechWaveFormatEx', 'DISPID_SRGDictationLoad',
    'DISPID_SRCEHypothesis', 'SPSLMA', 'SpeechPartOfSpeech',
    'SpeechRetainedAudioOptions', 'DISPID_SPRsCount',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SVSRunningState',
    'SpeechAudioFormatType', 'DISPID_SGRId', 'SAFTADPCM_11kHzStereo',
    'SAFT24kHz8BitStereo', 'SAFT11kHz8BitStereo', 'SREStreamStart',
    'SREAllEvents', 'DISPID_SAFGuid', 'SPAUDIOBUFFERINFO',
    'eLEXTYPE_LETTERTOSOUND', 'SPLEXICONTYPE',
    'DISPID_SGRSAddRuleTransition', 'SVF_None', 'SPPS_Modifier',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SGRSTWeight',
    'DISPID_SRCBookmark', 'DISPID_SPCPhoneToId', 'SpeechVoiceEvents',
    'DISPID_SDKGetStringValue', 'DISPID_SGRsItem',
    'DISPID_SDKDeleteKey', 'ISpeechVoice', 'SPAS_CLOSED', 'SPAS_STOP',
    ...
    'SpCustomStream', 'DISPID_SpeechDataKey', 'SPFM_NUM_MODES',
    'SpeechRegistryUserRoot', 'DISPID_SPARecoResult',
    'DISPID_SpeechVoice', 'SPEVENTSOURCEINFO', 'SPAS_RUN',
    'ISpeechPhraseInfoBuilder', 'SPCS_DISABLED', 'SPSHORTCUTPAIRLIST',
    'SPPS_Noun', 'SRTEmulated', 'DISPID_SABufferInfo',
    'DISPID_SPRules_NewEnum', 'SPINTERFERENCE_TOOLOUD',
    'Speech_StreamPos_RealTime', 'SPEI_VOICE_CHANGE',
    'SPEI_START_SR_STREAM', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SPAR_Unknown', 'DISPID_SGRSTNextState', 'SVEStartInputStream',
    'SVP_13', 'SPBO_TIME_UNITS', 'DISPID_SPPParent',
    'DISPID_SPIStartTime', 'ISpNotifySink', 'SREStreamEnd',
    'DISPID_SRCVoicePurgeEvent', 'SRERecoOtherContext', 'SPVPRI_OVER',
    'SRATopLevel', 'SVEAllEvents', 'SPSHT_EMAIL', 'SPWORD',
    'DISPID_SRCState', 'SpeechAudioFormatGUIDText',
    'eLEXTYPE_PRIVATE13', 'DISPID_SpeechObjectTokens',
    'SAFT44kHz8BitMono', 'SPFM_CREATE', 'DISPID_SGRName',
    'SREFalseRecognition', 'SDTAlternates',
    'DISPID_SREmulateRecognition', 'SpeechVoiceSpeakFlags',
    'DISPID_SpeechGrammarRuleState', 'eLEXTYPE_PRIVATE20',
    'eLEXTYPE_PRIVATE16', 'DISPID_SRGSetWordSequenceData',
    'SP_VISEME_3', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SLWLangId', 'SAFTGSM610_22kHzMono',
    'SAFTGSM610_44kHzMono', 'DISPID_SRIsUISupported', 'SVP_18',
    'SpeechTokenContext', 'SpeechGrammarWordType',
    'DISPID_SGRsCommitAndSave', 'SVP_0', 'DISPID_SVWaitUntilDone',
    'SpInprocRecognizer', 'DISPID_SGRSTPropertyId', 'SPPS_RESERVED3',
    'DISPID_SPRDisplayAttributes', 'DISPID_SpeechPhraseInfo',
    'SVP_17', 'DISPID_SPEAudioStreamOffset', 'DISPID_SVPriority',
    'DISPID_SVAudioOutput', 'SPAR_Medium', 'DISPID_SOTCId',
    'DISPID_SOTGetDescription', 'DISPID_SOTCDefault', 'SPRST_ACTIVE',
    'tagSPPROPERTYINFO', 'SRTReSent', 'SPPS_RESERVED2',
    'DISPID_SPAs_NewEnum', 'SAFT44kHz8BitStereo',
    'SAFTCCITT_ALaw_22kHzMono', 'eLEXTYPE_PRIVATE9',
    'DISPID_SpeechCustomStream', 'DISPID_SDKDeleteValue',
    'SPEI_SR_PRIVATE', 'SpNullPhoneConverter', 'ISpeechPhraseRule',
    'SPEI_RESERVED1', 'SAFTNoAssignedFormat', 'DISPID_SBSSeek',
    'SpeechRecoProfileProperties', 'DISPID_SVSLastBookmark',
    'DISPID_SRRAudio', 'SVP_1', 'DISPID_SAFType',
    'DISPID_SASCurrentDevicePosition', 'SpeechVisemeType',
    'SpeechFormatType', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SDKOpenKey', 'SpeechRunState', 'SpAudioFormat',
    'DISPID_SpeechPhraseReplacement', 'SPCT_DICTATION',
    'SAFTADPCM_44kHzStereo', 'SRCS_Enabled',
    'DISPID_SpeechPhraseProperties', 'SVPNormal', 'SPEI_MIN_SR',
    'DISPID_SRRTimes', 'SVSFIsFilename',
    'DISPID_SpeechRecoResultTimes', 'STCAll',
    'DISPID_SPAStartElementInResult', 'SVP_20',
    'SDA_Two_Trailing_Spaces', 'SSSPTRelativeToStart',
    'DISPID_SRSCurrentStreamPosition', 'SP_VISEME_1',
    'DISPID_SPEsItem', 'DISPID_SRGState', 'DISPID_SRRTStreamTime',
    'DISPID_SPILanguageId', 'DISPID_SRAudioInput',
    'DISPID_SDKSetBinaryValue', 'DISPID_SVAlertBoundary',
    'SPCT_COMMAND', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SMSALineId', 'DISPID_SRCRecognizer', 'DISPID_SGRsAdd',
    'DISPID_SOTsCount', 'DISPID_SPAsCount',
    'ISpeechObjectTokenCategory', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SpeechWaveFormatEx', 'SVP_14',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SPPConfidence', 'SVSFIsXML',
    'SWPUnknownWordUnpronounceable', 'SpObjectTokenCategory',
    'SGRSTTEpsilon', 'DISPID_SpeechRecoResult2',
    'ISpeechLexiconPronunciation', 'SVEBookmark', 'SASRun',
    'SGRSTTTextBuffer', 'DISPID_SLRemovePronunciation',
    'DISPID_SRCEBookmark', 'DISPID_SRGDictationSetState',
    'DISPID_SRCEEnginePrivate', 'SAFT22kHz16BitMono',
    'SVSFNLPSpeakPunc', 'STSF_FlagCreate', 'SpeechAddRemoveWord',
    'DISPID_SABIMinNotification', 'SGSEnabled', 'SPWORDLIST',
    'SLTUser', 'SVEPrivate', 'DISPID_SRCEEndStream',
    'SAFTADPCM_22kHzMono', 'SVSFPurgeBeforeSpeak',
    'SpeechAudioVolume', 'ISpResourceManager', 'DISPID_SVEBookmark',
    'SAFTExtendedAudioFormat', 'SITooLoud', 'SPEI_REQUEST_UI',
    'SPPS_RESERVED4', 'SPAR_High', 'eLEXTYPE_MORPHOLOGY',
    'SPSInterjection', 'DISPID_SpeechLexiconWords',
    'DISPID_SWFEFormatTag', 'SPEI_FALSE_RECOGNITION',
    'SPWORDPRONUNCIATIONLIST', 'SDTLexicalForm', 'SPLO_DYNAMIC',
    'SRESoundStart', 'SRAImport', 'SWTDeleted', 'DISPID_SLPPhoneIds',
    'SP_VISEME_21', 'SVP_16', 'SECFEmulateResult',
    'DISPID_SRGetPropertyNumber', 'DISPID_SRCEPhraseStart',
    'SSTTDictation', 'DISPID_SDKGetBinaryValue', 'SREPrivate',
    'DISPID_SRCCreateGrammar', 'DISPID_SVEStreamEnd',
    'DISPID_SRState', 'SDKLCurrentConfig', 'DISPID_SRRTTickCount',
    'DISPID_SLWType', 'DISPID_SpeechLexiconProns',
    'eLEXTYPE_RESERVED8', 'SPSNoun', 'DISPID_SPEDisplayAttributes',
    'SGDSInactive', 'DISPID_SRCERecognition', 'SAFT11kHz16BitMono',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SVSFlagsAsync',
    'DISPID_SpeechGrammarRules', 'SpeechCategoryVoices',
    'SpeechBookmarkOptions', 'SAFT24kHz16BitMono',
    'DISPID_SRGetPropertyString', 'SVEPhoneme', 'DISPID_SVSPhonemeId',
    'SREPropertyNumChange', 'ISpeechPhraseInfo',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SLTApp', 'SVP_15',
    'SPFM_CREATE_ALWAYS', 'SPRECOGNIZERSTATUS', 'DISPID_SGRsCount',
    'DISPID_SPPsCount', 'DISPID_SPRuleId', 'SRAExport',
    'DISPID_SRDisplayUI', 'DISPID_SOTCSetId', 'eWORDTYPE_ADDED',
    'SAFTGSM610_11kHzMono', 'ISpMMSysAudio', 'SPEI_END_SR_STREAM',
    'DISPID_SRCCmdMaxAlternates', 'SPRS_ACTIVE_USER_DELIMITED',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SDKSetLongValue',
    'SPEI_INTERFERENCE', 'STSF_CommonAppData',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SRCEPropertyStringChange',
    'SpeechPropertyResourceUsage', 'SVP_12', 'DISPID_SLWsCount',
    'SAFT8kHz16BitStereo', 'SpeechWordPronounceable',
    'SDKLCurrentUser', 'SPXRO_Alternates_SML',
    'DISPID_SRCEInterference', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SpeechPhraseReplacements', 'SPSUnknown', 'SP_VISEME_10',
    'SVP_7', 'SP_VISEME_20', 'ISpGrammarBuilder',
    'DISPID_SDKGetlongValue', 'SPADAPTATIONRELEVANCE',
    'ISpRecoGrammar', 'DISPID_SpeechRecoContext', 'DISPID_SRGId',
    'DISPID_SVGetAudioOutputs', 'DISPID_SVSInputWordLength',
    'DISPID_SRCEAdaptation', 'DISPID_SRCEventInterests',
    'DISPID_SVGetVoices', 'SPVISEMES', 'ISpeechObjectTokens',
    'SPSModifier', 'DISPID_SPEAudioSizeTime', 'ISpeechMMSysAudio',
    'DISPID_SRCEFalseRecognition',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SOTGetAttribute', 'ISpeechRecoResultTimes',
    'SpeechPropertyComplexResponseSpeed', 'SGRSTTRule',
    'SAFT8kHz8BitStereo', 'DISPID_SPAPhraseInfo',
    'SAFT48kHz8BitStereo', 'SPWF_INPUT', 'ISpeechObjectToken',
    'SDTRule', 'SP_VISEME_6', 'DISPID_SPRuleParent',
    'SAFT48kHz16BitStereo', 'ISpPhraseAlt', 'SGRSTTWildcard',
    'DISPID_SRRecognizer', 'SAFT32kHz16BitStereo', 'ISpRecognizer2',
    'DISPID_SRRSpeakAudio', 'SPEI_RESERVED5',
    'DISPID_SpeechVoiceStatus', 'SPPARTOFSPEECH', 'SAFT32kHz8BitMono',
    'SPRST_NUM_STATES', 'SPGS_EXCLUSIVE', 'SAFTCCITT_uLaw_8kHzMono',
    'SAFTGSM610_8kHzMono', 'SPINTERFERENCE_NOSIGNAL', 'SASClosed',
    'DISPID_SOTMatchesAttributes', 'SVEViseme', 'SPWORDPRONOUNCEABLE',
    'SECLowConfidence', 'DISPID_SGRsFindRule',
    'DISPID_SRCreateRecoContext', 'SPINTERFERENCE_NONE',
    'ISpeechCustomStream', 'SPINTERFERENCE_NOISE', 'SVF_Emphasis',
    'ISpeechResourceLoader', 'SRADefaultToActive',
    'tagSPTEXTSELECTIONINFO', 'ISpXMLRecoResult', 'SPPHRASERULE',
    'DISPID_SRSCurrentStreamNumber', 'ISpRecoContext',
    'DISPID_SGRSTsItem', 'ISpeechVoiceStatus', 'ISpShortcut',
    'SPSHT_Unknown', 'SVSFPersistXML', 'SVP_4',
    'DISPID_SVAudioOutputStream', 'DISPID_SRCSetAdaptationData',
    'SPPHRASEELEMENT', 'ISpeechPhraseProperty',
    'IInternetSecurityManager', 'DISPID_SLGetWords',
    'SAFT16kHz16BitStereo', 'SDA_Consume_Leading_Spaces', 'SpLexicon',
    'SPPS_NotOverriden', 'SP_VISEME_17', 'SPSERIALIZEDPHRASE',
    'SITooQuiet', 'DISPID_SRGDictationUnload', 'DISPID_SRGReset',
    'DISPID_SGRsDynamic', 'ISpeechRecognizer', 'SpeechTokenKeyUI',
    'ISpPhoneticAlphabetSelection', 'ISpeechPhraseAlternate',
    'SPEI_SENTENCE_BOUNDARY', 'SREPhraseStart', 'WAVEFORMATEX',
    'eLEXTYPE_RESERVED7', 'SPGRAMMARSTATE',
    'DISPID_SVSLastStreamNumberQueued', 'SAFT16kHz8BitStereo',
    'ISpStreamFormatConverter', 'SAFTADPCM_44kHzMono',
    'DISPID_SGRAddState', 'DISPID_SPIEngineId',
    'DISPID_SRCRetainedAudio', 'SpeechDataKeyLocation',
    'DISPID_SFSClose', 'SSFMOpenForRead', 'SPRST_INACTIVE',
    'SFTInput', 'SpTextSelectionInformation', 'ISpeechAudioFormat',
    'ISpeechPhraseAlternates', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SVSVisemeId', 'DISPID_SLPPartOfSpeech',
    '__MIDL_IWinTypes_0009', 'DISPID_SRCERequestUI',
    'DISPID_SRCESoundEnd', 'eLEXTYPE_USER_SHORTCUT', 'SVP_3',
    'ISpeechLexicon', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SVSLastBookmarkId', 'SREAdaptation', 'SLOStatic',
    'SPEI_MIN_TTS', 'SINoise', 'ISpEventSink', 'SpeechLoadOption',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SRRGetXMLResult', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SVEventInterests', 'DISPID_SPIGetText',
    'SPDKL_DefaultLocation', 'DISPID_SRProfile', 'ISpeechRecoResult',
    'DISPID_SVEWord', 'SVEWordBoundary', 'DISPID_SVEViseme',
    'ISpeechRecognizerStatus', 'IInternetSecurityMgrSite',
    'DISPID_SRCResume', 'DISPID_SGRSTText', 'SGRSTTDictation',
    'DISPID_SpeechGrammarRule', 'SpeechRecognizerState',
    'DISPID_SVPause', 'SPPS_Verb', 'DISPID_SPEAudioSizeBytes',
    'Speech_Default_Weight', 'SRCS_Disabled', 'SPEI_MAX_SR',
    'SRSInactiveWithPurge', 'ISequentialStream', 'SAFTDefault',
    'SP_VISEME_2', 'DISPID_SRRRecoContext',
    'DISPID_SGRSTPropertyValue', 'ISpeechAudio',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SpeechLexiconWord',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SAVolume',
    'SRTSMLTimeout', 'DISPID_SRRSaveToMemory', 'SPGRAMMARWORDTYPE',
    'SpeechRuleAttributes', 'DISPID_SpeechGrammarRuleStateTransition',
    'SPSHT_NotOverriden', 'SPAUDIOSTATE', 'DISPID_SPCLangId',
    'SRAInterpreter', 'SSTTTextBuffer', 'eLEXTYPE_RESERVED6',
    'SPEI_VISEME', 'SPAO_RETAIN_AUDIO',
    'DISPID_SpeechRecoContextEvents', 'DISPIDSPTSI_SelectionLength',
    'eLEXTYPE_RESERVED4', 'SAFT11kHz8BitMono', 'eLEXTYPE_PRIVATE17',
    'ISpeechAudioBufferInfo', 'DISPID_SVGetAudioInputs',
    'ISpeechPhoneConverter', 'SpeechCategoryRecoProfiles',
    'DISPID_SBSFormat', 'ISpObjectToken', 'ISpeechRecoResult2',
    'SAFTCCITT_ALaw_44kHzStereo', 'SpFileStream', 'eLEXTYPE_PRIVATE3',
    'DISPID_SVESentenceBoundary', 'SP_VISEME_15', 'SBOPause',
    'SECNormalConfidence', 'DISPID_SPELexicalForm',
    'ISpObjectTokenCategory', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SMSGetData', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SGRSTType', 'DISPID_SBSRead',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPSHT_OTHER',
    'SPEI_SOUND_END', 'SVEEndInputStream',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'ISpeechTextSelectionInformation', 'SASPause',
    'SpeechTokenIdUserLexicon', 'DISPID_SPRuleChildren',
    'ISpeechGrammarRuleStateTransitions', 'SPXMLRESULTOPTIONS',
    'SPEI_SR_AUDIO_LEVEL', 'SPSEMANTICFORMAT', 'DISPID_SLPsCount',
    'DISPID_SPERequiredConfidence', 'SVF_Stressed', 'SPRULESTATE',
    'SpStream', 'SAFTADPCM_22kHzStereo', 'DISPID_SMSSetData',
    'SPEVENT', 'SPINTERFERENCE_TOOFAST', 'SAFTADPCM_8kHzMono',
    'SPEI_HYPOTHESIS', 'SPEI_RESERVED3', 'DISPID_SpeechPhraseRules',
    'SP_VISEME_12', 'DISPID_SOTs_NewEnum', 'DISPID_SLPType',
    'SFTSREngine', 'SREBookmark', 'SVSFParseSapi',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SLWs_NewEnum',
    'DISPID_SRCRequestedUIType', 'DISPID_SVSpeak',
    'eLEXTYPE_PRIVATE1', 'SpeechVoicePriority',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SPACommit',
    'SDKLLocalMachine', 'SPPS_Noncontent', 'SpeechCategoryAudioOut',
    'DISPID_SWFEBitsPerSample', 'ISpeechRecoResultDispatch', 'SVP_8',
    'SPLOADOPTIONS', 'SAFT12kHz16BitStereo',
    'SGDSActiveUserDelimited', 'SpeechInterference',
    'DISPID_SVResume', 'SDKLDefaultLocation', '_SPAUDIOSTATE',
    'DISPID_SFSOpen', 'eLEXTYPE_VENDORLEXICON', 'ISpObjectWithToken',
    'tagSTATSTG', 'DISPID_SPPValue', 'DISPID_SpeechPhraseRule',
    'SPGS_ENABLED', 'SpeechAudioFormatGUIDWave', 'SRTStandard',
    'DISPID_SASNonBlockingIO', 'DISPID_SGRSTPropertyName',
    'SAFT44kHz16BitStereo', 'SpeechPropertyAdaptationOn',
    'SpeechAudioState', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SPAsItem', 'ISpLexicon', 'DISPID_SABIEventBias',
    'DISPID_SpeechLexiconPronunciation', 'eLEXTYPE_PRIVATE12',
    'SVSFIsNotXML', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SRStatus', 'DISPID_SPIRetainedSizeBytes', 'SPVPRI_NORMAL',
    'SVSFNLPMask', 'SpeechUserTraining', 'SECFIgnoreCase',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SASFreeBufferSpace',
    'DISPID_SRSAudioStatus', 'DISPID_SVSInputWordPosition',
    'DISPID_SpeechAudioStatus', 'SPWT_DISPLAY', 'DISPID_SpeechAudio',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'eLEXTYPE_PRIVATE4',
    'SRSActive', 'SRSEIsSpeaking', 'SAFT22kHz8BitStereo',
    '_ISpeechVoiceEvents', 'DISPID_SBSWrite', 'DISPID_SRGCommit',
    'ISpVoice', 'SPPHRASEREPLACEMENT', 'DISPID_SOTRemove',
    'SPINTERFERENCE_TOOQUIET', 'SPWT_PRONUNCIATION',
    'SPCT_SUB_COMMAND', 'SPEI_PHRASE_START', 'DISPID_SOTCGetDataKey',
    'ISpAudio', 'DISPID_SASCurrentSeekPosition', 'ISpStreamFormat',
    'DISPID_SPPName', 'DISPID_SPPFirstElement',
    'DISPID_SVEStreamStart', 'SAFT32kHz8BitStereo',
    'DISPID_SPRuleFirstElement', 'Speech_Max_Pron_Length',
    'DISPID_SPRsItem', 'SECFIgnoreWidth', 'SSFMOpenReadWrite',
    'DISPID_SMSADeviceId', 'SPEI_ADAPTATION', 'eLEXTYPE_RESERVED9',
    'eLEXTYPE_PRIVATE6', 'SAFT48kHz16BitMono',
    'DISPID_SRGCmdLoadFromMemory', 'SPEI_PHONEME',
    'DISPID_SOTGetStorageFileName', 'DISPID_SMSAMMHandle',
    'SPFM_OPEN_READWRITE', 'SpeechMicTraining',
    'DISPID_SCSBaseStream', 'ISpRecoGrammar2', 'DISPID_SASState',
    'DISPID_SOTsItem', 'SPEI_TTS_BOOKMARK', 'SpNotifyTranslator',
    'eLEXTYPE_USER', 'DISPID_SRSetPropertyNumber',
    'DISPID_SPIGrammarId', 'DISPID_SGRAddResource', 'SREInterference',
    'SpSharedRecoContext', 'SAFTText', 'SECFNoSpecialChars',
    'SPSHORTCUTTYPE', 'DISPID_SLRemovePronunciationByPhoneIds',
    'LONG_PTR', 'SRSActiveAlways', 'SDTDisplayText',
    'DISPID_SLPLangId', 'SITooFast', 'eLEXTYPE_PRIVATE10',
    'STCRemoteServer', 'SpMMAudioEnum', 'SpShortcut',
    'DISPID_SWFEChannels', 'SINone', 'SVP_10', 'SVP_11',
    'ISpeechXMLRecoResult', 'eLEXTYPE_PRIVATE11', 'SP_VISEME_11',
    'SpMMAudioOut', 'IEnumSpObjectTokens', 'SpeechVisemeFeature',
    'STSF_AppData', 'SDTAudio', 'SAFTADPCM_11kHzMono',
    'SPSTREAMFORMATTYPE', 'SP_VISEME_9', 'SPAUDIOOPTIONS',
    'ISpRecognizer3', 'SAFT12kHz8BitStereo', 'DISPID_SLWWord',
    'SAFT48kHz8BitMono', 'SP_VISEME_19', 'DISPID_SPRNumberOfElements',
    'DISPID_SGRSTransitions', 'DISPID_SpeechVoiceEvent',
    'DISPID_SVVolume', 'SP_VISEME_14', 'DISPID_SVEVoiceChange',
    'DISPID_SGRSAddSpecialTransition', 'SPEI_WORD_BOUNDARY',
    'DISPID_SPEPronunciation', 'DISPID_SVSkip', 'eLEXTYPE_RESERVED10',
    'DISPID_SRCPause', 'UINT_PTR', 'DISPID_SLPSymbolic',
    'DISPID_SASetState', 'SVP_6', 'SpeechDisplayAttributes',
    'SPCS_ENABLED', 'SpeechCategoryRecognizers', 'SPBINARYGRAMMAR',
    'SPPS_LMA', 'SpeechEngineProperties', 'DISPID_SVRate',
    'DISPID_SPIEnginePrivateData', 'DISPID_SGRAttributes',
    'DISPID_SPIReplacements', 'SpeechStreamSeekPositionType',
    'SPPHRASEPROPERTY', 'SAFT22kHz8BitMono', 'DISPID_SPIElements',
    'Speech_Max_Word_Length', 'SAFTCCITT_ALaw_22kHzStereo',
    'STCLocalServer', 'DISPID_SpeechBaseStream', 'SAFT12kHz8BitMono',
    'DISPID_SGRInitialState', 'SPPS_SuppressWord', 'SPCONTEXTSTATE',
    'SASStop', 'DISPID_SLGetGenerationChange',
    'SpeechTokenKeyAttributes', 'SpeechSpecialTransitionType',
    'DISPID_SVSLastResult', 'SPCT_SLEEP', 'SPRS_ACTIVE',
    'SPSHORTCUTPAIR', 'SPSSuppressWord', 'ISpEventSource',
    'SpeechDiscardType', 'DISPID_SpeechRecognizer',
    'DISPID_SpeechPhraseElements', 'SPINTERFERENCE_TOOSLOW',
    'SRERecognition', 'SpeechWordType', 'SSSPTRelativeToEnd',
    'SPINTERFERENCE_LATENCY_WARNING', 'SpeechRecoContextState',
    'SDA_One_Trailing_Space', 'ISpProperties', 'SPAUDIOSTATUS',
    'DISPID_SRGetRecognizers', 'SpeechRuleState',
    'SSSPTRelativeToCurrentPosition', 'SSFMCreateForWrite',
    'ISpeechGrammarRule', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SPANumberOfElementsInResult', 'SVPOver',
    'DISPID_SVEAudioLevel', 'SPSMF_SRGS_SAPIPROPERTIES',
    'eLEXTYPE_PRIVATE18', '_ISpeechRecoContextEvents', 'SBONone',
    'SINoSignal', 'DISPID_SpeechPhoneConverter', 'SPSNotOverriden',
    'SpObjectToken', 'DISPID_SPEActualConfidence',
    'DISPID_SDKCreateKey', 'ISpPhrase', 'SAFT12kHz16BitMono',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPFILEMODE', 'SGRSTTWord',
    'DISPID_SLWsItem', 'SpCompressedLexicon', 'SpeechRecognitionType',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SPRFirstElement',
    'SPEI_MAX_TTS', 'SPEI_RECO_OTHER_CONTEXT', 'SPEI_UNDEFINED',
    'SVPAlert', 'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'STCInprocServer',
    'DISPID_SPISaveToMemory', 'ISpeechMemoryStream',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SOTCategory',
    'SECHighConfidence', 'DISPID_SOTId', 'DISPID_SPPEngineConfidence',
    'SPINTERFERENCE', 'SpMMAudioIn', 'DISPID_SRCVoice',
    'DISPID_SVSpeakCompleteEvent', 'SAFT16kHz16BitMono',
    'DISPID_SRCESoundStart', 'ISpeechPhraseRules',
    'DISPID_SPRulesCount', 'ISpStream', 'SGDisplay',
    'SPBOOKMARKOPTIONS', 'SAFT8kHz8BitMono',
    'SpeechVoiceCategoryTTSRate', 'SpeechVoiceSkipTypeSentence',
    'ISpDataKey', 'SAFTCCITT_ALaw_8kHzMono', 'ISpeechGrammarRules',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SPXRO_SML',
    'SPDKL_CurrentConfig', 'SpInProcRecoContext',
    'DISPID_SPIAudioSizeBytes', 'ISpeechGrammarRuleState',
    'SVEAudioLevel', 'ISpRecoResult', 'SpeechDictationTopicSpelling',
    'DISPID_SWFEAvgBytesPerSec', 'SRSInactive',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SGRClear', 'SPPROPERTYINFO',
    'SpeechGrammarTagDictation', '_RemotableHandle', 'DISPIDSPRG',
    'SVSFDefault', 'SVP_5', 'ISpeechFileStream', 'SPPS_RESERVED1',
    'SPEI_RESERVED6', 'SVP_9', 'DISPID_SRAudioInputStream',
    'SRADynamic', 'SAFT24kHz8BitMono', 'DISPID_SpeechMemoryStream',
    'SPEI_START_INPUT_STREAM', 'SPWORDPRONUNCIATION',
    'SAFT22kHz16BitStereo', 'DISPIDSPTSI_SelectionOffset', 'SPPHRASE',
    'DISPID_SpeechPhraseElement', 'DISPID_SWFEExtraData',
    'SRTAutopause', 'SITooSlow', 'SpStreamFormatConverter',
    'DISPID_SPCIdToPhone', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SOTIsUISupported', 'SP_VISEME_18', 'DISPID_SVEPhoneme',
    'ISpNotifySource', 'eWORDTYPE_DELETED', 'SVSFParseMask', 'SVP_21',
    'DISPID_SRCERecognizerStateChange', 'SAFT24kHz16BitStereo',
    'DISPID_SRGCmdLoadFromResource', 'SpMemoryStream',
    'DISPID_SVStatus', 'SAFTADPCM_8kHzStereo',
    'DISPID_SPEEngineConfidence', 'SPVPRIORITY', 'SP_VISEME_16',
    'DISPID_SPRuleName', 'SpeechTokenKeyFiles',
    'ISpeechPhraseReplacement', 'SWPKnownWordPronounceable',
    'eLEXTYPE_PRIVATE8', 'DISPID_SDKSetStringValue',
    'DISPID_SRRSetTextFeedback', 'SPAO_NONE', 'ISpNotifyTranslator',
    'DISPID_SRGetFormat', 'SpPhraseInfoBuilder', 'SRARoot',
    'SDA_No_Trailing_Space', 'DISPID_SADefaultFormat', 'SP_VISEME_0',
    'eLEXTYPE_PRIVATE14', 'DISPID_SLGenerationId',
    'ISpeechLexiconWords', 'DISPID_SLGetPronunciations',
    'DISPID_SVDisplayUI', 'DISPID_SLPsItem', 'DISPID_SWFEBlockAlign',
    'DISPID_SRCEAudioLevel', 'SAFT32kHz16BitMono',
    'DISPID_SPEAudioTimeOffset', 'SpeechCategoryAudioIn', 'SpVoice',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPAS_PAUSE',
    'DISPID_SRRTLength', 'SPRECORESULTTIMES', 'DISPID_SRRAlternates',
    'SAFTCCITT_uLaw_44kHzStereo', 'SREHypothesis', 'SPBO_NONE',
    'SLODynamic', 'DISPID_SRRGetXMLErrorInfo', 'DISPID_SGRSRule',
    'DISPID_SPIAudioStreamPosition', 'ISpeechBaseStream',
    'DISPID_SDKEnumValues', 'DISPID_SABufferNotifySize',
    'SpResourceManager', 'DISPID_SVSpeakStream',
    'SPTEXTSELECTIONINFO', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SpeechFileStream', 'SAFTCCITT_uLaw_11kHzMono',
    'ISpeechPhraseProperties', 'DISPID_SPIProperties',
    'SVSFUnusedFlags', 'DISPID_SVSInputSentencePosition',
    'SPPS_Interjection', 'SPWAVEFORMATTYPE', 'ISpeechPhraseElements',
    'SPRST_ACTIVE_ALWAYS', 'SREPropertyStringChange',
    'SPSMF_SAPI_PROPERTIES', 'SPPS_Unknown', 'SDTProperty',
    'eLEXTYPE_PRIVATE15', 'SpSharedRecognizer',
    'DISPID_SpeechRecoResult', 'SPAR_Low', 'DISPID_SpeechLexicon',
    'SPCT_SUB_DICTATION', 'DISPID_SRSSupportedLanguages',
    'ISpeechAudioStatus', 'SDTPronunciation', 'ISpSerializeState',
    'SPDKL_CurrentUser', 'DISPID_SVIsUISupported', 'SREAudioLevel',
    'DISPID_SGRSAddWordTransition', 'DISPID_SPIRule', 'SP_VISEME_4',
    'SRAORetainAudio', 'SPCATEGORYTYPE', 'ISpPhoneConverter',
    'SPRECOSTATE', 'SAFT8kHz16BitMono', 'ISpRecoContext2',
    'ISpeechRecoContext', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SGSDisabled', 'SPPS_Function', 'DISPID_SVSyncronousSpeakTimeout',
    'SpeechRegistryLocalMachineRoot', 'SpeechTokenValueCLSID'
]

_check_version('1.2.0', 1697076171.756596)
